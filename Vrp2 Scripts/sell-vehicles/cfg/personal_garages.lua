...
cfg.force_out_fee = 2000

cfg.garage_ptypes = {
["Personal"] = { --Add all personal garage cars
  _config = {map_entity = {"PoI", {vtype = "car", marker_id = 1, scale = {4.0,4.0,1.0},color={5, 229, 246,125} }}},		
    ["blista"] = {"Blista", 15000, ""},
...
-- {garage_type,x,y,z}
cfg.pgarages = {
  {"Personal", 67.509803771972,6371.6772460938,-50.737434387208},
