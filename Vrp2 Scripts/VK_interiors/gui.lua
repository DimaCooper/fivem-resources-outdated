gui_interiors = {
	...
	currentpos = nil,
	selectedbutton = 0,
	marker = { r =151, g = 122, b = 244, a = 125, type = 1 }, 
	menu = {
		x = 0.08,
		y = 0.25,
		width = 0.16,
...
function gui_interiors_drawMenuTitle(txt,x,y)
	...
	DrawRect(x,y,menu.width,menu.height,57,46,92,255)
...
function gui_interiors_drawMenuButton(button,x,y,selected)
	...
	if selected then
		DrawRect(x,y,menu.width,menu.height,100,65,164,200)
	else
		DrawRect(x,y,menu.width,menu.height,32,28,43,150)
	end
	DrawText(x - menu.width/2 + 0.005, y - menu.height/2 + 0.0028)
end
-------------------------------------------------
...
function gui_interiors_drawMenuInfo(text)
	...
	SetTextColour(100,65,164, 255)
	SetTextCentre(0)
	SetTextEntry("STRING")
	AddTextComponentString(text)
	DrawRect(0.675, 0.95,0.65,0.050,32,28,43,100)
...
function gui_interiors_drawMenuRight(txt,x,y,selected)
	...
	SetTextEntry("STRING")
	AddTextComponentString(txt)
    DrawRect(0.01 + (menu.width)+((menu.width/3)/2),y,menu.width/3,menu.height,100,65,164,150)
