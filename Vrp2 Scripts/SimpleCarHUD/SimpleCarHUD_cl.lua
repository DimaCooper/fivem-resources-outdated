...
-- SEATBELT PARAMETERS
local seatbeltInput = 113                   -- Toggle seatbelt on/off with K or DPAD down (controller)
...
local seatbeltEjectSpeed = 190.0             -- Speed threshold to eject player (MPH)
local seatbeltEjectAccel = 180.0            -- Acceleration threshold to eject player (G's)
    ...
    while true do
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                -- Set PED flags
                SetPedConfigFlag(PlayerPedId(), 64, true)
                --[[
