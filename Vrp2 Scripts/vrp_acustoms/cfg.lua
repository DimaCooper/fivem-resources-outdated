--ver 0.94
shops = {
	[0] = {coords = {x = -210.0, y = -1318.0}, title = "Benny's Motoworks"},
	[1] = {coords = {x = -345.0, y = -135.0}, title = "Los Santos Customs"},
	[2] = {coords = {x = 730.92, y = -1088.67}, title = "LA Mesa LSC"},	
	[3] = {coords = {x = 1100.59, y = -3144.65}, title = "Biker's Customs"},
...
dataBaseUpdatedText = "Saved"
customColourText = "Custom Color"
updateFailedText = "Could not save"
notEnoughMoneyText = "Not enough money"
inviteText = "Press ~r~Enter~w~ to activate~n~~b~"
confirmExitText = "Press ~r~Enter~w~ to leave~n~or ~r~Backspace~w~ to stay"
...
menuInfo = {
	[1] 			= {modID = nil, 	nameCar = "Features", 		nameBike = "Features", 		parent = 0, 	_type = "", 		price = 0, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
		...
		[13] 		= {modID = 10, 		nameCar = "Roof", 				nameBike = "Бак", 				parent = 1, 	_type = "get", 		price = 3, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
		...
		[60] 		= {modID = nil, 	nameCar = "Lighting", 			nameBike = "Lighting", 		parent = 1, 	_type = "lights", 	price = 0, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
			[61] 	= {modID = nil, 	nameCar = "Under Glow", 	nameBike = "Under Glow", 	parent = 60, 	_type = "n",		price = 5, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
				[62]= {modID = nil, 	nameCar = "Colour", 				nameBike = "Colour", 				parent = 61, 	_type = "nc", 		price = 0, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
	...
	[80] 			= {modID = nil, 	nameCar = "Specifications", 	nameBike = "Specifications", 	parent = 0, 	_type = "", 		price = 0, 			prog = 0, 			children = 0, 		set = -1, 		cart = -1},
		...
		[85] 		= {modID = 16, 		nameCar = "Protection", 			nameBike = "Protection", 			parent = 80, 	_type = "unlstd", 	price = 10, 		prog = 1, 			children = 0, 		set = -1, 		cart = -1},
		[86] 		= {modID = 18, 		nameCar = "turbo", 		nameBike = "turbo", 		parent = 80, 	_type = "turbo", 	price = 10, 		prog = 0, 			children = 0, 		set = -1, 		cart = -1},
	[87] 			= {modID = nil, 	nameCar = "Additions", 		nameBike = "Additions", 		parent = 0, 	_type = "extra", 	price = 1, 			prog = 0, 			children = 0,		set = -1, 		cart = -1},
	[88] 			= {modID = nil, 	nameCar = "Fix and Clean", 			nameBike = "Fix and Clean", 			parent = 0, 	_type = "rep", 		price = 0, 			prog = 0, 			children = 0,		set = -1, 		cart = -1},
	[89] 			= {modID = nil, 	nameCar = "Install", 		nameBike = "Install", 		parent = 0, 	_type = "inst",		price = 0, 			prog = 0, 			children = 0,		set = -1, 		cart = -1},
}
